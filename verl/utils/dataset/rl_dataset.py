    ...
    def _read_files_and_tokenize(self):
        ...
        if self.filter_overlong_prompts:
            ...
            if processor is not None:
                ...
                # Warn once if tokenizer has no chat_template
                if tokenizer.chat_template is None:
                    logger.warning(
                        "Tokenizer does not have a chat_template set. Falling back to concatenating message contents. "
                        "For accurate prompt length filtering, consider setting tokenizer.chat_template."
                    )
                ...
                def doc2len(doc) -> int:
                    ...
                    if tokenizer.chat_template is not None:
                        ...
                        # Fallback: concatenate message contents and tokenize directly
                        ...
                        for msg in messages:
                            if isinstance(msg, dict) and "content" in msg:
                                ...
                                text += msg + " "
                        return len(tokenizer.encode(text.strip(), add_special_tokens=True))
